...
public class Aplic {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Medida da altura: " + retObj.getHeight()); //Envia os dados à tela
        System.out.println("Medida da altura: " + retObj.getWidth()); //Envia os dados à tela
        ...
        System.out.println("Medida da diagonal: " + retObj.calcDiagonal()); //Envia os dados à tela
